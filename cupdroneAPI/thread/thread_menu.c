...
static void _menu_show_headfree( void )
{
	_menu_printf("H:%d", rcOptions[BOXHEADFREE]);
}
...
static void _menu_show_menu(void)
{
	...
	_menu_printf("\n\r\n\r");
	_menu_printf("*******************************************************\n\r");
	_menu_printf("         CupDrone ");
	_menu_printf(_SKYROVER_VER_STR_); _menu_show_vbat(); _menu_show_headfree();
	_menu_printf("\r\n");
	_menu_printf("*******************************************************\n\r");
